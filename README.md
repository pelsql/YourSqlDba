...
**To get the script of the most recent release of YourSqlDba** - **[click here to display lastest release 6.8.0.1](YourSQLDba_InstallOrUpdateScript.sql?raw=true)**
...
**[Get script of 6.8.0.1](YourSQLDba_InstallOrUpdateScript.sql?raw=true)**
